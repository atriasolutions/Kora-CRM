...
type UsersFiltersMenuProps = {
  filters: UserFilters
  onFiltersChange: (filters: UserFilters) => void
}

export function UsersFiltersMenu({ filters, onFiltersChange }: UsersFiltersMenuProps) {
    ...
    <DropdownMenu>
      ...
      >
        ...
        <button
          ...
          onClick={() => onFiltersChange(createDefaultUserFilters())}
        >
          Limpiar filtros
        </button>
      </DropdownMenuContent>
