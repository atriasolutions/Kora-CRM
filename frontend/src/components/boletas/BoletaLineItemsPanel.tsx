...
type BoletaLineItemsPanelProps = {
  lineItems: InvoiceLineItem[]
  className?: string
}

export function BoletaLineItemsPanel({ lineItems, className }: BoletaLineItemsPanelProps) {
  return (
    <Card className={cn('shadow-sm', className)}>
      <CardHeader>
        <CardTitle className="text-base font-semibold">Líneas de boleta</CardTitle>
      </CardHeader>
