...
import { ProjectsFiltersMenu } from '@/components/projects/ProjectsFiltersMenu'
...
export type ProjectsViewId = StandardModuleViewId

type ProjectsModuleHeaderProps = {
  view: ProjectsViewId
  ...
  onListScopeChange?: (scope: ProjectListScope) => void
  archivedCount?: number
  toolbarEnd?: ReactNode
}

export function ProjectsModuleHeader({
  view,
  onViewChange,
  query,
  onQueryChange,
      ...
      <div className="flex items-start justify-between gap-3 md:items-center">
        <div className="min-w-0">
          ...
          <p className="mt-1 hidden text-sm text-muted-foreground md:block">
            {view === 'archivados'
              ? 'Papelera de reciclaje: restaura o elimina proyectos archivados.'
              : 'Implementaciones, entregas y seguimiento de avance por cliente.'}
            {activeFilters > 0
        ...
        <div className="flex shrink-0 items-center gap-2">
          {view !== 'archivados' ? (
            <ProjectsFiltersMenu filters={filters} onFiltersChange={onFiltersChange} />
          ) : null}
      ...
      <ModuleListToolbarBar
        viewSwitcher={
          <ModuleViewSwitcher
            ...
            tablistAriaLabel="Vista de proyectos"
        ...
        search={
          <ModuleSearchField
            ...
            placeholder={
              view === 'archivados' ? 'Buscar en archivados…' : 'Buscar proyectos…'
            }
