/** Regiones de Chile (división administrativa de primer nivel). */
...
const COMMUNES: Record<ChileRegion, readonly string[]> = {
  ...
  "O'Higgins": ["Chépica", "Chimbarongo", "Codegua", "Coinco", "Coltauco", "Doñihue", "Graneros", "La Estrella", "Las Cabras", "Litueche", "Lolol", "Machalí", "Malloa", "Marichihue", "Mostazal", "Nancagua", "Navidad", "Olivar", "Palmilla", "Paredones", "Peralillo", "Peumo", "Pichidegua", "Pichilemu", "Placilla", "Pumanque", "Quinta de Tilcoco", "Rancagua", "Rengo", "Requínoa", "San Fernando", "San Vicente", "Santa Cruz"],
  ...
  "Ñuble": ["Bulnes", "Chillán", "Chillán Viejo", "Cobquecura", "Coelemu", "Coihueco", "El Carmen", "Ninhue", "Ñiquén", "Pemuco", "Pinto", "Portezuelo", "Quillón", "Quirihue", "Ránqui", "San Carlos", "San Fabián", "San Ignacio", "San Nico", "Treguaco", "Yungay"],
...
export function getCommunesForRegion(region: string): string[] {
  if (!region.trim()) return []
  const match = CHILE_REGIONS.find((r) => r === region)
  if (!match) return []
  return [...COMMUNES[match]]
}

export function isChileRegion(value: string): value is ChileRegion {
  return (CHILE_REGIONS as readonly string[]).includes(value)
}
