...
/** Partes de fecha/hora en Chile para un instante UTC. */
...
/** Interpreta `datetime-local` como hora en Chile y devuelve instante UTC. */
...
export function chileDatetimeLocalToIso(value: string): string | undefined {
  const date = parseChileDatetimeLocal(value)
